...
window.addEventListener('load', function () {
  ...
  var eventHandler = function eventHandler(evt) {
    ...
    switch ((_evt$detail = evt.detail) === null || _evt$detail === void 0 ? void 0 : _evt$detail.direction) {
      case 'up':
        mainMenu.selectorUp();
        scenePause.selectorUp();
        gameOver.selectorUp();
        (_snake = snake) === null || _snake === void 0 || _snake.faceUp();
        break;
      case 'down':
        mainMenu.selectorDown();
        gameOver.selectorDown();
        scenePause.selectorDown();
        (_snake2 = snake) === null || _snake2 === void 0 || _snake2.faceDown();
        break;
      case 'left':
        (_snake3 = snake) === null || _snake3 === void 0 || _snake3.faceLeft();
        break;
      case 'right':
        (_snake4 = snake) === null || _snake4 === void 0 || _snake4.faceRight();
        break;
    }
  };
